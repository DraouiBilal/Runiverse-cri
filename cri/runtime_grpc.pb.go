...
const (
	RuntimeService_RunCode_FullMethodName = "/cri.RuntimeService/RunCode"
)
...
func (c *runtimeServiceClient) RunCode(ctx context.Context, in *RunCodeRequest, opts ...grpc.CallOption) (*RunCodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RunCodeResponse)
	err := c.cc.Invoke(ctx, RuntimeService_RunCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRuntimeServiceServer) RunCode(context.Context, *RunCodeRequest) (*RunCodeResponse, error) {
...
func _RuntimeService_RunCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RuntimeServiceServer).RunCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RuntimeService_RunCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RuntimeServiceServer).RunCode(ctx, req.(*RunCodeRequest))
	}
...
var RuntimeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cri.RuntimeService",
	HandlerType: (*RuntimeServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RunCode",
			Handler:    _RuntimeService_RunCode_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cri/proto/runtime.proto",
}
